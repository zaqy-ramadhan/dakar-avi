...
<div class="row mb-3">
    ...
    <div class="col-sm-6 col-md-6 col-lg-4 mb-3">
        ...
        <select name="religion" class="form-control" id="religion">
            ...
            <option value="Islam" {{ old('religion', $employeeDetail->religion ?? '') == 'Islam' ? 'selected' : '' }}>Islam</option>
            <option value="Kristen" {{ old('religion', $employeeDetail->religion ?? '') == 'Kristen' ? 'selected' : '' }}>Kristen</option>
            <option value="Katolik" {{ old('religion', $employeeDetail->religion ?? '') == 'Katolik' ? 'selected' : '' }}>Katolik</option>
            <option value="Hindu" {{ old('religion', $employeeDetail->religion ?? '') == 'Hindu' ? 'selected' : '' }}>Hindu</option>
            <option value="Buddha" {{ old('religion', $employeeDetail->religion ?? '') == 'Buddha' ? 'selected' : '' }}>Buddha</option>
            <option value="Konghucu" {{ old('religion', $employeeDetail->religion ?? '') == 'Konghucu' ? 'selected' : '' }}>Konghucu</option>
            <option value="Lainnya" {{ old('religion', $employeeDetail->religion ?? '') == 'Lainnya' ? 'selected' : '' }}>Lainnya</option>
        </select>
        @error('religion')
            <div class="text-danger">{{ $message }}</div>
        @enderror
    ...
    <div class="col-sm-6 col-md-6 col-lg-6 mb-3">
        ...
        <select name="tax_status" class="form-select" id="tax_status" >
            ...
            <option value="K3"
                ...
                tanggungan</option>
            <option value="K10"
                {{ old('tax_status', $employeeDetail->tax_status ?? '') == 'K10' ? 'selected' : '' }}>K/I/0 penghasilan suami dan istri digabung dan tidak ada tanggungan</option>
            <option value="K11"
                {{ old('tax_status', $employeeDetail->tax_status ?? '') == 'K11' ? 'selected' : '' }}>K/I/1 penghasilan suami dan istri digabung dan 1 tanggungan</option>
            <option value="K12"
                {{ old('tax_status', $employeeDetail->tax_status ?? '') == 'K12' ? 'selected' : '' }}>K/I/2 penghasilan suami dan istri digabung dan 2 tanggungan</option>
            <option value="K13"
                {{ old('tax_status', $employeeDetail->tax_status ?? '') == 'K13' ? 'selected' : '' }}>K/I/3 penghasilan suami dan istri digabung dan 3 tanggungan</option>
