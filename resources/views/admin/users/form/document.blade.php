...
<div class="row mb-3">
    <div class="col-sm-4 col-md-4 col-lg-4 mb-3">
        ...
        <small class="text-muted">Wajib diisi</small>
        @if($familyCard)
            <p>File yang ada: <a href="{{ asset('storage/' . $familyCard->doc_path) }}" target="_blank">Lihat File</a></p>
        @endif
    ...
    <div class="col-sm-4 col-md-4 col-lg-4 mb-3">
        ...
        <input type="file" class="form-control" id="child_birth_certificate_file" name="child_birth_certificate_file">
        @if($childBirthCert)
            <p>File yang ada: <a href="{{ asset('storage/' . $childBirthCert->doc_path) }}" target="_blank">Lihat File</a></p>
        @endif
...
<div class="row mb-3">
    <div class="col-sm-6 col-md-6 col-lg-4 mb-3">
        ...
        @if($marriageCert)
            <p>File yang ada: <a href="{{ asset('storage/' . $marriageCert->doc_path) }}" target="_blank">Lihat File</a></p>
        @endif
    ...
    <div class="col-sm-6 col-md-6 col-lg-4 mb-3">
        <label for="photo_file" class="form-label">Foto Buku Tabungan Rekening Bank <span class="text-danger">*</span></label>
    ...
    <div class="col-sm-6 col-md-6 col-lg-4 mb-3">
        <label for="photo_file" class="form-label">Pas Foto dalam bentuk .jpeg <span class="text-danger">*</span></label>
